...
class HeaderItem(object):
    ...
    def __init__(self, size, buff, cm):
        ...
        self.meta_size  = buff.get_idx() - self.offset
...
class DalvikCode(object):
    ...
    def __init__(self, buff, cm):
        ...
        self.meta_size  = buff.get_idx() - self.offset
      #  print "{0}, {1}, {2}".format(self.offset, self.meta_size, self.offset + self.meta_size)
...
class MapItem(object):
    ...
    def next(self, buff, cm):
        ...
        if TYPE_MAP_ITEM[ self.type ] == "TYPE_STRING_ID_ITEM":
            ...
            self.item = CodeHItem( self.size, buff, cm )
